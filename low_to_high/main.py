...
def train(resume=False, paths=None):
    ...
    for epo in range(start_epoch, hyper['epoch']+200):
        for npy_index in range(10):
            ...
            # print('fake_sample.type', type(fake_sample))
...
if __name__ == '__main__':
    model_paths = ['/home/lipeiying/program/_SR_/Lmser_GAN/low_to_high/checkpoint_low_high/model/generator_199.pth',
                   '/home/lipeiying/program/_SR_/Lmser_GAN/low_to_high/checkpoint_low_high/model/discriminator_199.pth']
    # train()
