...
def train(cuda='0', resume=False, paths=None, ckpt='ckpt'):
    # delete_ckpt()
    os.environ["CUDA_VISIBLE_DEVICES"] = cuda
    hyper['ckpt_dir'] = ckpt
    print('===> Build Model')
    # generator = Generator.Generator()
    lmser = lmser_gate.Lmser()
    ...
    if resume:
        ...
        start_epoch = checkpoint_lmser["epoch"] + 2
    ...
    for epo in range(start_epoch, hyper['epoch'] - start_epoch + 1):
        ...
        for npy_index in range(10):
            ...
            for i, batch_data in enumerate(data_train_loader):
                ...
                lr_img, hr_img, HR_avg_pool, cor_list = lmser(HR_img, z)
            ...
            cor_log = write_txt(cor_log, 'cor.txt')
